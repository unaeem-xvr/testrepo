...
public interface IAccountService
{
    ...
    void Register(RegisterRequest model, string origin, Guid userId);
...
public class AccountService : IAccountService
{
    ...
    public void Register(RegisterRequest model, string origin, Guid userId)
    {
        // validate
    ...
    private string generateJwtToken(Account account)
    {
        ...
        {
            Subject = new ClaimsIdentity(new[] { new Claim("id", account._Id.ToString()) }),
